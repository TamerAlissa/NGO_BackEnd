const
    ...
    {AddNewCourses,getAllCourses,deleteCourse,getAllCoursestrainee,getALLtrainer,updataInfromationCOurses,getOneCourse, SearchCourse,getAllCoursesNgo,registerTrainee,UNRegisterTrainee,GetRegisteredTrainees} = require('../coursesRep/courseRepository.js'),
...
let pagesize=20;
  ...
  router.get(routeBase + '/title/:title' , (req, res) => {
...
getAllCoursesNgo(id_ngo,(getAllCoursesByNgoFaild, getAllCoursesByNgosuccssed)=>{
  ...
  router.get(routeBase+'/trainee/:id_course' , (req, res) =>{
    ...
    registerTrainee(id_course,(registerTraineeFaild,registerTraineessuccssed)=>{
      console.log(registerTraineessuccssed)
  ...
  router.delete(routeBase+'/trainee/:id_trainee' , (req, res) =>{
    ...
    UNRegisterTrainee(id_trainee,(UNregisterTraineeFaild,UNregisterTraineessuccssed)=>{
      console.log(UNregisterTraineeFaild)
      console.log(UNregisterTraineessuccssed)
      res.send(UNregisterTraineessuccssed);
    })
  });
  router.get(routeBase+'/trainee/:id_trainee' , (req, res) =>{
    let id_trainee=req.params.id_trainee;
    getAllCoursestrainee(id_trainee,(getcoursesTraineeFaild,getcoursesTraineessuccssed)=>{
      // console.log(getcoursesTraineeFaild)
      console.log(getcoursesTraineessuccssed)
      res.send(getcoursesTraineessuccssed);
    })
  });
